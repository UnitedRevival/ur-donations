...
export default function BostonEvent({ amountRaised, goal, cardTitle }: HomePageProps) {
  return (
...
export const getServerSideProps: GetServerSideProps<HomePageProps> = async (ctx) => {
  ...
  return {
    props: {
      ...
      cardTitle: `Help Fund Jesus March Boston ${CAMPAIGN_YEAR}`, // Pass it through props
