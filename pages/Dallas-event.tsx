...
export default function DallasEvent({ amountRaised, goal, cardTitle }: HomePageProps) {
  return (
...
export const getServerSideProps: GetServerSideProps<HomePageProps> = async (ctx) => {
  ...
  const jesusMarchDonations = totals.find(
    (t) => t._id === current_Diffrent_campaigns.JESUS_MARCH_2025_DALLAS.title
  );
  ...
  return {
    props: {
      ...
      cardTitle: 'Thanks For Signing-Up For Jesus March Dallas 2025',
    },
  };
};