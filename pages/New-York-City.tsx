...
export default function NewYorkCity({ amountRaised, goal, cardTitle }: HomePageProps) {
  return (
...
export const getServerSideProps: GetServerSideProps<HomePageProps> = async (ctx) => {
  ...
  return {
    props: {
      ...
      cardTitle: `Thanks For Signing-Up For Jesus March New York City ${CAMPAIGN_YEAR}`,
